...
cp /root/NVME_Back/fio_script/fio.sh $log_dir"/fio-backup.sh"
...
#host
/root/NVME_Back/fio_script/kill.sh vmstat
/root/NVME_Back/fio_script/kill.sh iostat
rm -rf /tmp/*stat.log
...
/root/NVME_Back/fio_script/kill.sh vmstat
/root/NVME_Back/fio_script/kill.sh iostat
cp /tmp/vmstat.log $stat_log_dir"/_vmstat.log"
cp /tmp/iostat.log $stat_log_dir"/_iostat.log"
...
echo "9. Get log file and Update git"

cp -r /root/fio_log /root/NVME_Back/
cd /root/NVME_Back
